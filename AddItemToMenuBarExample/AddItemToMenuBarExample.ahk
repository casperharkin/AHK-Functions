...
/*
    AddMenu.ahk is an AutoHotkey script designed to create custom context menus in 
    any running window (e.g., Notepad) and provide dynamic actions based on menu 
    selections. It leverages the Windows API to add a menu with custom items and 
    handle event-driven actions such as changing the clipboard contents based on user 
    input.

    This script can be customized and extended to include additional functionality, 
    making it ideal for creating context menus that interact with other parts of your 
    ...
    Author's Note:
    If you encounter any issues or wish to contribute improvements, feel free to reach 
    out via my GitHub repository or provide feedback.

    Example Usage:
    To use this script, simply launch it and a custom menu will be added to the active 
    window (Notepad). Select the relevant menu item to manipulate the clipboard text:
        - "Uppercase" converts the clipboard text to uppercase.
        - "Lowercase" converts the clipboard text to lowercase.
        - "Titlecase" converts the clipboard text to titlecase.
    ...
    You can modify the menu items and the corresponding actions based on your needs.
*/
